...
{
public:
  BuildPointCloudTask(const dvo::core::RgbdImage& image, const dvo::core::IntrinsicMatrix& intrinsics, const Eigen::Affine3d& pose, AsyncPointCloudBuilder::DoneCallback& callback) :
...
AsyncPointCloudBuilder::BuildJob::BuildJob(const dvo::core::RgbdImage& image, const dvo::core::IntrinsicMatrix& intrinsics, const Eigen::Affine3d pose) :
  image(image),
...
void AsyncPointCloudBuilder::build(const dvo::core::RgbdImage& image, const dvo::core::IntrinsicMatrix& intrinsics, const Eigen::Affine3d pose)
{
