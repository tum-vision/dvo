...
public:
  ...
  public:
    ...
    BuildJob(const dvo::core::RgbdImage& image, const dvo::core::IntrinsicMatrix& intrinsics, const Eigen::Affine3d pose = Eigen::Affine3d::Identity());
  ...
  void build(const dvo::core::RgbdImage& image, const dvo::core::IntrinsicMatrix& intrinsics, const Eigen::Affine3d pose = Eigen::Affine3d::Identity());
